...
def ask_question2(original_summary, query, docsearch):
    ...
    chat_history = [
        {'role': 'system', 'content': 'you are a helpful assistant.'},
        {'role': 'user', 'content': 'Here is the original summary: ' + '"""' + original_summary + '""", and here is the additional information: ' + '"""' + add_answer + '""", can you add the additional information to the original summary and organise a new summary?'},
        {'role': 'assistant', 'content': ""},
    ]
